...
* change this manually;
%include "/workspace/workbench/pac_qrp_swingtech/data/SAS/Quarterly and Annual Reporting/2023-Q4 OR/Extract and Assemble Assessments/Programs/Assemble_Assessments_Common_20240412.sas";
...
* Naming parameters - update from common macro ;
	...
	*	Folders update automatically	;
	%put NOTE: manually triger overriding common assignment, replace after predev is done ; 
	%let folder = 2023-Q4 OR ; 
...
***	Requires manual update	***;
	...
	* Current quarter's assessment extracts ;
	%LET in_asmt = IRF_DBX_ASMT_XTRCT_&year.&quarter._240415 ;
	%LET in_asmt_hist = IRF_DBX_HIST_XTRCT_&year.&quarter._240415 ;

	* Use provider extract to incorporate CCNs (missing from ASMT tables) ;
	%LET in_prvdr = lib_prvd.IRF_PRVDR_XTRCT_240415 ;
